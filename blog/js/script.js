(function($){
  ...
  $('body').on('click', function(){
    ...
    var $this = $(this),
        ...
        description = "%0a" + $('meta[property="og:description"]').attr("content").slice(0, 112) + "..."; //换行符+描述+...
    ...
    if ($('#' + id).length){
      ...
      var html = [
        ...
        '<a href="http://service.weibo.com/share/share.php?appkey=2081818014&title='+ "【" + title + "】" + description +'&url=' + encodedUrl + '&searchPic=false&style=simple" class="article-share-weibo" target="_blank" title="微博"></a>',
